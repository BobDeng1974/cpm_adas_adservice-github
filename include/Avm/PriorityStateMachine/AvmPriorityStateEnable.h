#ifndef __HARMAN_ADAS_APROJECT_GWMV2MH_AVM_PRIORITY_STATE_ENABLE_H__
#define __HARMAN_ADAS_APROJECT_GWMV2MH_AVM_PRIORITY_STATE_ENABLE_H__
...
class CAvmPriorityStateEnable : public State
{
public:
    CAvmPriorityStateEnable(const string& name, StateMachine* sm, CAvmEngineStateMachine* Subsm)
        : State(name, sm)
...
#endif //__HARMAN_ADAS_APROJECT_GWMV2MH_AVM_PRIORITY_STATE_ENABLE_H__
