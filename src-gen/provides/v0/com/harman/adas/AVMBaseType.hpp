...
*/
#ifndef V0_COM_HARMAN_ADAS_AVM_Base_Type_HPP_
#define V0_COM_HARMAN_ADAS_AVM_Base_Type_HPP_
...
namespace std {
    ...
    template<>
    struct hash<::v0::com::harman::adas::AVMBaseType::enAVMStatus> {
        inline size_t operator()(const ::v0::com::harman::adas::AVMBaseType::enAVMStatus& enAVMStatus) const {
            return static_cast<int32_t>(enAVMStatus);
        }
    };
    //Hash for enAVMViewMode
    template<>
    struct hash<::v0::com::harman::adas::AVMBaseType::enAVMViewMode> {
        inline size_t operator()(const ::v0::com::harman::adas::AVMBaseType::enAVMViewMode& enAVMViewMode) const {
            return static_cast<int32_t>(enAVMViewMode);
        }
    };
    //Hash for enAVMGuideLineMode
    template<>
    struct hash<::v0::com::harman::adas::AVMBaseType::enAVMGuideLineMode> {
        inline size_t operator()(const ::v0::com::harman::adas::AVMBaseType::enAVMGuideLineMode& enAVMGuideLineMode) const {
            return static_cast<int32_t>(enAVMGuideLineMode);
        }
    };
    //Hash for enAVMCamState
    template<>
    struct hash<::v0::com::harman::adas::AVMBaseType::enAVMCamState> {
        inline size_t operator()(const ::v0::com::harman::adas::AVMBaseType::enAVMCamState& enAVMCamState) const {
            return static_cast<int32_t>(enAVMCamState);
        }
    };
    //Hash for enAutoCaliState
    template<>
    struct hash<::v0::com::harman::adas::AVMBaseType::enAutoCaliState> {
        inline size_t operator()(const ::v0::com::harman::adas::AVMBaseType::enAutoCaliState& enAutoCaliState) const {
            return static_cast<int32_t>(enAutoCaliState);
        }
    };
    //Hash for enAutoCaliWorkModeAuto
    template<>
    struct hash<::v0::com::harman::adas::AVMBaseType::enAutoCaliWorkModeAuto> {
        inline size_t operator()(const ::v0::com::harman::adas::AVMBaseType::enAutoCaliWorkModeAuto& enAutoCaliWorkModeAuto) const {
            return static_cast<int32_t>(enAutoCaliWorkModeAuto);
        }
    };
    //Hash for enAutoCaliWorkModeManu
    template<>
    struct hash<::v0::com::harman::adas::AVMBaseType::enAutoCaliWorkModeManu> {
        inline size_t operator()(const ::v0::com::harman::adas::AVMBaseType::enAutoCaliWorkModeManu& enAutoCaliWorkModeManu) const {
...
#endif // V0_COM_HARMAN_ADAS_AVM_Base_Type_HPP_
