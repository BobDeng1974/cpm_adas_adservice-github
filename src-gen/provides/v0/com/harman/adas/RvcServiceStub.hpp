...
*/
#ifndef V0_COM_HARMAN_ADAS_Rvc_Service_STUB_HPP_
#define V0_COM_HARMAN_ADAS_Rvc_Service_STUB_HPP_
...
class RvcServiceStubAdapter
 ...
 public:
    ///Notifies all remote listeners about a change of value of the attribute RvcState.
    virtual void fireRvcStateAttributeChanged(const ::v0::com::harman::adas::RVCBaseType::enRvcState& RvcState) = 0;
...
public:
    ...
    /// Provides getter access to the attribute RvcState
    virtual const ::v0::com::harman::adas::RVCBaseType::enRvcState &getRvcStateAttribute(const std::shared_ptr<CommonAPI::ClientId> _client) = 0;
...
#endif // V0_COM_HARMAN_ADAS_Rvc_Service_STUB_HPP_
