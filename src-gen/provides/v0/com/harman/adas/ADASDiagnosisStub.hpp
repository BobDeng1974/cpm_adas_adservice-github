...
#include <v0/com/harman/adas/ADASDiagType.hpp>
...
{
public:
    typedef std::function<void (::v0::com::harman::adas::ADASDiagType::enDiagTestState _m_DiagTest)>triggerCameraTestingReply_t;
