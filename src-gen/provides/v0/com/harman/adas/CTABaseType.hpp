...
*/
#ifndef V0_COM_HARMAN_ADAS_CTA_Base_Type_HPP_
#define V0_COM_HARMAN_ADAS_CTA_Base_Type_HPP_
...
namespace std {
    ...
    template<>
    struct hash<::v0::com::harman::adas::CTABaseType::enCTAStatus> {
        inline size_t operator()(const ::v0::com::harman::adas::CTABaseType::enCTAStatus& enCTAStatus) const {
            return static_cast<int32_t>(enCTAStatus);
        }
    };
    //Hash for enCTAWorkMode
    template<>
    struct hash<::v0::com::harman::adas::CTABaseType::enCTAWorkMode> {
        inline size_t operator()(const ::v0::com::harman::adas::CTABaseType::enCTAWorkMode& enCTAWorkMode) const {
...
#endif // V0_COM_HARMAN_ADAS_CTA_Base_Type_HPP_
