...
*/
#ifndef V0_COM_HARMAN_ADAS_ADAS_Diag_Type_HPP_
#define V0_COM_HARMAN_ADAS_ADAS_Diag_Type_HPP_
...
namespace std {
    ...
    template<>
    struct hash<::v0::com::harman::adas::ADASDiagType::enDiagTestState> {
        inline size_t operator()(const ::v0::com::harman::adas::ADASDiagType::enDiagTestState& enDiagTestState) const {
...
#endif // V0_COM_HARMAN_ADAS_ADAS_Diag_Type_HPP_
