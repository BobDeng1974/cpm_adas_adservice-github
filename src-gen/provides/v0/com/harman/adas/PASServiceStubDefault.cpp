...
const std::vector<::v0::com::harman::adas::PASBaseType::enPASStatus>& PASServiceStubDefault::getPASStatusAttribute() {
    return pASStatusAttributeValue_;
}

const std::vector<::v0::com::harman::adas::PASBaseType::enPASStatus>& PASServiceStubDefault::getPASStatusAttribute(const std::shared_ptr<CommonAPI::ClientId> _client) {
    (void)_client;
    return getPASStatusAttribute();
}

void PASServiceStubDefault::setPASStatusAttribute(std::vector<::v0::com::harman::adas::PASBaseType::enPASStatus> _value) {
...
bool PASServiceStubDefault::trySetPASStatusAttribute(std::vector<::v0::com::harman::adas::PASBaseType::enPASStatus> _value) {
...
bool PASServiceStubDefault::validatePASStatusAttributeRequestedValue(const std::vector<::v0::com::harman::adas::PASBaseType::enPASStatus> &_value) {
    (void)_value;
	return true;
}
...
void PASServiceStubDefault::SwitchPASView(const std::shared_ptr<CommonAPI::ClientId> _client, ::v0::com::harman::adas::PASBaseType::enPASViewStatus _m_ePASViewStatus, SwitchPASViewReply_t _reply) {
    (void)_client;
