...
const ::v0::com::harman::adas::AdasType::aModuleState& AdasServiceStubDefault::getCurrentStateAttribute() {
    return currentStateAttributeValue_;
}

const ::v0::com::harman::adas::AdasType::aModuleState& AdasServiceStubDefault::getCurrentStateAttribute(const std::shared_ptr<CommonAPI::ClientId> _client) {
    (void)_client;
    return getCurrentStateAttribute();
}

void AdasServiceStubDefault::setCurrentStateAttribute(::v0::com::harman::adas::AdasType::aModuleState _value) {
...
bool AdasServiceStubDefault::trySetCurrentStateAttribute(::v0::com::harman::adas::AdasType::aModuleState _value) {
...
bool AdasServiceStubDefault::validateCurrentStateAttributeRequestedValue(const ::v0::com::harman::adas::AdasType::aModuleState &_value) {
    (void)_value;
	return true;
}
...
void AdasServiceStubDefault::getModuleState(const std::shared_ptr<CommonAPI::ClientId> _client, std::string _moduleName, getModuleStateReply_t _reply) {
    (void)_client;
    (void) _moduleName;
    ::v0::com::harman::adas::AdasType::eModuleStates moduleState = ::v0::com::harman::adas::AdasType::eModuleStates::OFF;
...
void AdasServiceStubDefault::fireAAdasModuleStateEvent(const ::v0::com::harman::adas::AdasType::aModuleState &_modulesState) {
