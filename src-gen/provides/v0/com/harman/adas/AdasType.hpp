...
*/
#ifndef V0_COM_HARMAN_ADAS_Adas_Type_HPP_
#define V0_COM_HARMAN_ADAS_Adas_Type_HPP_
...
namespace std {
    ...
    template<>
    struct hash<::v0::com::harman::adas::AdasType::eModuleStates> {
        inline size_t operator()(const ::v0::com::harman::adas::AdasType::eModuleStates& eModuleStates) const {
...
#endif // V0_COM_HARMAN_ADAS_Adas_Type_HPP_
