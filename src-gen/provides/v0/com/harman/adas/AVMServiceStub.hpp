...
#include <v0/com/harman/adas/AVMBaseType.hpp>
#include <v0/com/harman/adas/CTABaseType.hpp>
...
class AVMServiceStubAdapter
 ...
 public:
    ...
    virtual void fireAVMCamStatusAttributeChanged(const ::v0::com::harman::adas::AVMBaseType::stAVMCamState& AVMCamStatus) = 0;
    ///Notifies all remote listeners about a change of value of the attribute CTAStatus.
    virtual void fireCTAStatusAttributeChanged(const ::v0::com::harman::adas::CTABaseType::stCTAStatus& CTAStatus) = 0;
    ///Notifies all remote listeners about a change of value of the attribute AutoStatus.
    virtual void fireAutoStatusAttributeChanged(const ::v0::com::harman::adas::AVMBaseType::enAutoCaliState& AutoStatus) = 0;

    /**
     * Sends a broadcast event for bcAVMViewStatus. Should not be called directly.
     * Instead, the "fire<broadcastName>Event" methods of the stub should be used.
     */
    virtual void fireBcAVMViewStatusEvent(const ::v0::com::harman::adas::AVMBaseType::enAVMStatus &_m_AVMStatus) = 0;
...
public:
    ...
    virtual const ::v0::com::harman::adas::AVMBaseType::stAVMCamState &getAVMCamStatusAttribute(const std::shared_ptr<CommonAPI::ClientId> _client) = 0;
    /// Provides getter access to the attribute CTAStatus
    virtual const ::v0::com::harman::adas::CTABaseType::stCTAStatus &getCTAStatusAttribute(const std::shared_ptr<CommonAPI::ClientId> _client) = 0;
    /// Provides getter access to the attribute AutoStatus
    virtual const ::v0::com::harman::adas::AVMBaseType::enAutoCaliState &getAutoStatusAttribute(const std::shared_ptr<CommonAPI::ClientId> _client) = 0;

    /// This is the method that will be called on remote calls on the method SwitchAVMView.
    virtual void SwitchAVMView(const std::shared_ptr<CommonAPI::ClientId> _client, ::v0::com::harman::adas::AVMBaseType::enAVMViewMode _m_eAVMViewMode, SwitchAVMViewReply_t _reply) = 0;
    /// This is the method that will be called on remote calls on the method SwitchGuideline.
    virtual void SwitchGuideline(const std::shared_ptr<CommonAPI::ClientId> _client, ::v0::com::harman::adas::AVMBaseType::enAVMGuideLineMode _m_eAVMGuideLinewMode, SwitchGuidelineReply_t _reply) = 0;
    /// This is the method that will be called on remote calls on the method SwitchCTA.
    virtual void SwitchCTA(const std::shared_ptr<CommonAPI::ClientId> _client, ::v0::com::harman::adas::CTABaseType::enCTAWorkMode _m_eCATMode, SwitchCTAReply_t _reply) = 0;
    /// This is the method that will be called on remote calls on the method SwitchAutoCalibrationAuto.
    virtual void SwitchAutoCalibrationAuto(const std::shared_ptr<CommonAPI::ClientId> _client, ::v0::com::harman::adas::AVMBaseType::enAutoCaliWorkModeAuto _m_eAutoCaliMode, SwitchAutoCalibrationAutoReply_t _reply) = 0;
    /// This is the method that will be called on remote calls on the method SwitchAutoCalibrationManually.
    virtual void SwitchAutoCalibrationManually(const std::shared_ptr<CommonAPI::ClientId> _client, ::v0::com::harman::adas::AVMBaseType::enAutoCaliWorkModeManu _m_eAutoCaliMode, SwitchAutoCalibrationManuallyReply_t _reply) = 0;
