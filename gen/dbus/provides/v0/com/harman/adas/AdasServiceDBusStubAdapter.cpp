...
CommonAPI::DBus::DBusGetAttributeStubDispatcher<
        ::v0::com::harman::adas::AdasServiceStub,
        ::v0::com::harman::adas::AdasType::aModuleState,
        ::v0::com::harman::adas::AdasType_::aModuleStateDeployment_t
...
CommonAPI::DBus::DBusMethodWithReplyStubDispatcher<
    ...
    std::tuple<::v0::com::harman::adas::AdasType::eModuleStates>,
...
void AdasServiceDBusStubAdapterInternal::fireCurrentStateAttributeChanged(const ::v0::com::harman::adas::AdasType::aModuleState& value) {
    CommonAPI::Deployable<::v0::com::harman::adas::AdasType::aModuleState, ::v0::com::harman::adas::AdasType_::aModuleStateDeployment_t> deployedValue(value, static_cast<::v0::com::harman::adas::AdasType_::aModuleStateDeployment_t*>(nullptr));
...
void AdasServiceDBusStubAdapterInternal::fireAAdasModuleStateEvent(const ::v0::com::harman::adas::AdasType::aModuleState& modulesState) {
    CommonAPI::DBus::DBusStubSignalHelper<CommonAPI::DBus::DBusSerializableArguments<
    CommonAPI::Deployable<::v0::com::harman::adas::AdasType::aModuleState, ::v0::com::harman::adas::AdasType_::aModuleStateDeployment_t>
    >>::sendSignal(
            *this,
            "aAdasModuleState",
            "a(si)",
    CommonAPI::Deployable<::v0::com::harman::adas::AdasType::aModuleState, ::v0::com::harman::adas::AdasType_::aModuleStateDeployment_t>(modulesState, static_cast<::v0::com::harman::adas::AdasType_::aModuleStateDeployment_t*>(nullptr))
    );
}
