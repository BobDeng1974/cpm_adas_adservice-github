...
#include <v0/com/harman/adas/AdasTypeDBusDeployment.hpp>        
...
public:
    ...
    void fireCurrentStateAttributeChanged(const ::v0::com::harman::adas::AdasType::aModuleState& value);

    void fireAAdasModuleStateEvent(const ::v0::com::harman::adas::AdasType::aModuleState& modulesState);
